...
struct SwapChainFrame {
    ...
    void make_descriptor_resources(vk::Device logicalDevice,
        ...
        cameraDataWriteLocation = logicalDevice.mapMemory(
            cameraDataBuffer.bufferMemory, 0, sizeof(UBO));
