...
uint32_t vkUtil::findMemoryTypeIndex(
...
void vkUtil::allocateBufferMemory(Buffer& buffer,
	...
	*/
    vk::MemoryRequirements memoryRequirements =
        input.logicalDevice.getBufferMemoryRequirements(buffer.buffer);
...
void vkUtil::copyBuffer(Buffer& srcBuffer, Buffer& dstBuffer,
	...
	*/
    ...
    commandBuffer.copyBuffer(srcBuffer.buffer, dstBuffer.buffer, 1,
                             &copyRegion);
