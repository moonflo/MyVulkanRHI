...
/**
	...
	*/
vk::AttachmentDescription make_color_attachment(
...
GraphicsPipelineOutBundle create_graphics_pipeline(
    ...
    vk::PipelineVertexInputStateCreateInfo vertexInputInfo =
        make_vertex_input_info(bindingDescription, attributeDescriptions);
    pipelineInfo.pVertexInputState = &vertexInputInfo;

    //Input Assembly
    vk::PipelineInputAssemblyStateCreateInfo inputAssemblyInfo =
        make_input_assembly_info();
    ...
    vk::PipelineShaderStageCreateInfo vertexShaderInfo =
        make_shader_info(vertexShader, vk::ShaderStageFlagBits::eVertex);
    ...
    vk::PipelineViewportStateCreateInfo viewportState =
        make_viewport_state(viewport, scissor);
    ...
    vk::PipelineShaderStageCreateInfo fragmentShaderInfo =
        make_shader_info(fragmentShader, vk::ShaderStageFlagBits::eFragment);
...
vk::RenderPass make_renderpass(vk::Device device,
    ...
    vk::AttachmentDescription colorAttachment =
        make_color_attachment(swapchainImageFormat);

    //Declare that attachment to be color buffer 0 of the framebuffer
    vk::AttachmentReference colorAttachmentRef =
        make_color_attachment_reference();
    ...
    vk::RenderPassCreateInfo renderpassInfo =
        make_renderpass_info(colorAttachment, subpass);
    try {
