...
void VertexMenagerie::finalize(
    vertexBufferFinalizationChunk finalizationChunk) {
    ...
    void* memoryLocation =
        logicalDevice.mapMemory(stagingBuffer.bufferMemory, 0, inputChunk.size);
    ...
    vkUtil::copyBuffer(stagingBuffer, vertexBuffer, inputChunk.size,
                       finalizationChunk.queue,
