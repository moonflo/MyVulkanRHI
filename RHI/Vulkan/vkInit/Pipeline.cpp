...
void vkInit::PipelineBuilder::specify_vertex_format(
    ...
    vertexInputInfo.pVertexAttributeDescriptions =
        this->attributeDescriptions.data();
}
...
void vkInit::PipelineBuilder::add_color_attachment(const vk::Format& format,
    ...
    attachmentDescriptions.insert(
        {attachment_index,
         make_renderpass_attachment(format, loadOp, storeOp, initialLayout,
                                    finalLayout)});
    attachmentReferences.insert(
        {attachment_index,
         make_attachment_reference(attachment_index,
...
vk::AttachmentDescription vkInit::PipelineBuilder::make_renderpass_attachment(
    ...
    vk::AttachmentStoreOp storeOp, vk::ImageLayout initialLayout,
...
vk::RenderPass vkInit::PipelineBuilder::make_renderpass() {
    ...
    vk::SubpassDescription subpass =
        make_subpass(flattenedAttachmentReferences);
    //Now create the renderpass
    vk::RenderPassCreateInfo renderpassInfo =
        make_renderpass_info(flattenedAttachmentDescriptions, subpass);
    try {
