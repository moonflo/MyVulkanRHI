...
#include "vkUtil/RenderStructs.h"
...
class PipelineBuilder {
   ...
   public:
    ...
    void specify_depth_attachment(const vk::Format& depthFormat,
   ...
   private:
    ...
    /**
			...
			*/
    vk::AttachmentReference make_attachment_reference(uint32_t attachment_index,
